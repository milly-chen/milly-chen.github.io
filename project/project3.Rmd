...
![Figure 3 A) This graph shows the average number of genes associated with each HH-responsive GBR identified by the intersection. Almost 80% of the genes have on average 2 HH-responsive GBR regulating it. B) This graph shows the average distance of the HH-responsive GBRs from the HH target genes. 60% of the target genes are 50kb to 500kb away from the active enhancer.](/project/project3_files/Picture4.png)
...
![Figure 5 This is a figure showing how BMP is a target gene of HH signaling and how BMP can also act as a negative regulator of HH signaling. I hypothesize that Smoc1 will act as a positive regulator on HH signaling because it will inhibit BMP from inhibiting HH signaling.](/project/project3_files/Picture6.png)
